...
public class DAOCurso {
     ...
     */
    public static Curso consultar(int id) {
        Session session;
        session = ConexaoHibernate.getInstance();
        Transaction tx = null;
        ...
        try {
            ...
            q = session.createQuery("FROM Curso as c where c.id=:id");
     ...
     */
    public static boolean alterar(Curso c) {
        Session session;
        session = ConexaoHibernate.getInstance();
        Transaction tx = null;
     ...
     */
    public static boolean excluir(Curso d) {
        Session session;
        session = ConexaoHibernate.getInstance();
        Transaction tx = null;
